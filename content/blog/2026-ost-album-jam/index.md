...
By then *hopefully* Linux gets native support from pro-audio companies like EastWest, Native Instruments or even better Steinberg bringing Cubase to linux :star_struck:  
...
Hopefully EastWest doesn't take a week to respond to my license reset request like last time :crossed_fingers:
#### Audio
{{< audio src="OrchTest_AnthemVar_1_2.ogg">}}
...
While working on this first draft of the idea I hadn't realised that I'd subconsiously took the Ta-Taa figure from my anthem track which had used that at parts of it and only realised it after making this first draft :sweat_smile:
...
#### Audio
{{< audio src="OrchTest_Stage1_1_1.ogg">}}
...
#### Audio
{{< audio src="OrchTest_Stage1_1_3.ogg">}}

## Challenge track time?
...
{{< audio src="OrchTest_Boss_1_1.ogg">}}
...
Now I could work more on the original [Anthem Track](#audio-1), but I kind of made a newer version of it while waiting for the ILOK issue to get fixed + having two versions of pretty much the same thing might be a bit boring.
...
#### Audio
{{< audio src="OrchTest_Stage1_1_4.ogg">}}
...
{{< audio src="OrchTest_Stage1_1_6.ogg">}}
...
{{< audio src="OrchTest_StealthMission_1_1.ogg">}}
...
{{< audio src="OrchTest_StealthMission_1_2.ogg">}}
...
Usually I've put all of the tracks back to back in 1 video, but since I did separate uploads per track for the last [OST Composing Jam: Overtime](/blog/ost-composing-jam-overtime/) I will do a video per track for this one as well.
...
Stock video loop I used for the video background is by <a href="https://pixabay.com/users/andyally-21520248/?utm_source=link-attribution&utm_medium=referral&utm_campaign=video&utm_content=154434">Andy Ally</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=video&utm_content=154434">Pixabay</a>

## Final Submission
<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?si=sKD23lfNsJPdxNuH&amp;list=PLR3yAUIUpR9Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
